            ...
            <div className="modalBody">
              ...
              <div className="modalSubHeading">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                  <path d="M11 22C17.0751 22 22 17.0751 22 11C22 4.92487 17.0751 0 11 0C4.92487 0 0 4.92487 0 11C0 17.0751 4.92487 22 11 22Z" fill="#FFDD67"/>
                  <path d="M6.78335 10.8533C7.79587 10.8533 8.61668 10.0325 8.61668 9.01999C8.61668 8.00747 7.79587 7.18666 6.78335 7.18666C5.77082 7.18666 4.95001 8.00747 4.95001 9.01999C4.95001 10.0325 5.77082 10.8533 6.78335 10.8533Z" fill="#664E27"/>
                  <path d="M15.2166 10.8533C16.2292 10.8533 17.05 10.0325 17.05 9.01999C17.05 8.00747 16.2292 7.18666 15.2166 7.18666C14.2041 7.18666 13.3833 8.00747 13.3833 9.01999C13.3833 10.0325 14.2041 10.8533 15.2166 10.8533Z" fill="#664E27"/>
                  <path d="M7.69998 16.72C9.82664 14.96 12.1733 14.96 14.3 16.72C14.5566 16.94 14.7766 16.5733 14.5933 16.2433C13.9333 14.9967 12.65 13.86 11 13.86C9.34998 13.86 8.02998 14.9967 7.40664 16.2433C7.22331 16.5733 7.44331 16.94 7.69998 16.72Z" fill="#664E27"/>
                </svg>
                </span> */}
              </div>
              {/* <div className="descriptionText">
                To finish the level keep playing and answer 3 more questions correctly!
              </div> */}
              ...
              <div className="d-flex justify-content-center">
                ...
                >
                  ...
                  You have <span className="coinsCount">120</span> coins
                </Button>
              </div>
              <div className="d-flex align-items-center justify-content-center">
                <Button
            ...
            <div className="modalBody">
              ...
              <div className="d-flex justify-content-center">
                ...
                <Button
                  variant="primary"
                  className="goBackBtnLarge"
                  onClick={() => props.handleBuyCoinPopupShow(popupTypes[3], 'retryGame')}
                >
                  <span className="emojiIcon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
